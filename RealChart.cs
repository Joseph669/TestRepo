...
namespace MainInterface
{
    public partial class MainFunc : Form
    {
        ...
        private void openPort_Click(object sender, EventArgs e)
        {
            ...
            CommonVal.Workspace = GetWorkSpace();
            ...
            //_serialPort.RequestMultipleWaveTransfer(DataConstants.WF_REQ_CONT_START, DataConstants.DRI_LEVEL_2005);
            //_serialPort.RequestMultipleWaveTransfer(DataConstants.WF_REQ_CONT_START, DataConstants.DRI_LEVEL_2003);
            //_serialPort.RequestMultipleWaveTransfer(DataConstants.WF_REQ_CONT_START, DataConstants.DRI_LEVEL_2001);
        ...
        {
            CommonVal.DataType = comboBox2.SelectedItem.ToString();
        }
        ...
        {
            MessageBox.Show(
                "1.连接好心电仪后，选择测试者类型、测试者ID、数据类型\r\n" +
                "2.之后选择串口并点击打开串口按钮，数据开始写入，并且软件开始显示实时心电图\r\n" +
                "3.测完一组数据后，点击关闭串口按钮，数据停止写入\r\n" +
                "4.重新选择测试者类型、测试者ID、数据类型，再点击打开串口按钮，即可继续写入数据\r\n" +
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            MessageBox.Show(
                ...
                "3.测完一组数据后，点击关闭串口按钮，数据停止写入\r\n" +
                "4.重新选择测试者类型、测试者ID、数据类型，再点击打开串口按钮\r\n" +
                "5.实验结束后，直接点击右上角的关闭，即可结束程序\r\n\r\n" +
                "注意事项：\r\n" +
                "1.测完一组数据后，务必要先关闭串口，不然监护仪缓存区还会存在要发送的数据，导致下次接收的数据前几秒的数据是上一次残留未发送的数据；\r\n" +
...
//        private void button1_Click(object sender, EventArgs e)
//        {
//            axWindowsMediaPlayer1.URL = @"C:\Users\78144\Desktop\test.mp4";
...
//            //this.axWindowsMediaPlayer1.StatusChange += new System.EventHandler(axWindowsMediaPlayer1_StatusChange);
//        }
//    }
//}
